...
function saveJson({ newName, jsonData, }) {
    node_fs_1.default.writeFileSync(`./public/json/${newName}.json`, JSON.stringify(jsonData));
}
...
function checkAndUpdate(name) {
    const fileNamesData = node_fs_1.default.readFileSync("src/DB/usedNames.json", "utf-8");
    ...
    node_fs_1.default.writeFileSync("src/DB/usedNames.json", JSON.stringify(fileNames, null, 2));
    return newName;
}
